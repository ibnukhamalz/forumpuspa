        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <form method="post" action="<?= base_url('/welcome/myprofile'); ?>">
                        <div class="card-body pb-2">
                            <input type="hidden" name="link" value="anggota/detail/<?= $userdata->id ?? ''; ?>">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="exampleInputPassword2">Reset Password</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i data-feather="lock"></i></span>
                                    <input name="password" class="form-control" id="exampleInputPassword2" type="password" placeholder="Reset Password">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input readonly name="nama_singkat" class="form-control" id="exampleFormControlInput1" type="text" placeholder="Nama Singkat" value="<?= set_value('nama_singkat', $cruddata->nama_singkat ?? ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            ...
                                            <input readonly name="nama_lengkap" class="form-control" id="validationCustom01" type="text" placeholder="Nama Lengkap" value="<?= set_value('nama_lengkap', $cruddata->nama_lengkap ?? ''); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input readonly name="name_user" class="form-control" id="exampleFormControlInput1" type="text" placeholder="Nama Kontak" value="<?= set_value('name_user', $cruddata->name_user ?? ''); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input readonly name="no_telp_mitra" class="form-control" id="exampleFormControlInput1" type="text" placeholder="No Telepon" value="<?= set_value('no_telp_mitra', $cruddata->no_telp_mitra ?? ''); ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text"><i data-feather="phone"></i></span>
                                                <input readonly name="no_wa" class="form-control" id="exampleFormControlInput1" type="text" placeholder="WhatsApp / Telegram" value="<?= set_value('no_wa', $cruddata->no_wa ?? ''); ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input readonly name="email_mitra" class="form-control" id="exampleFormControlInput1" type="email" placeholder="Email" value="<?= set_value('email_mitra', $cruddata->email_mitra ?? ''); ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input readonly name="website_mitra" class="form-control" id="exampleFormControlInput1" type="text" name="nama_singkat" placeholder="http://website.com" value="<?= set_value('website_mitra', $cruddata->website_mitra ?? ''); ?>">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <textarea readonly class="form-control" name="alamat_mitra" placeholder="Alamat dan Kode Pos"><?= set_value('alamat_mitra', $cruddata->alamat_mitra ?? ''); ?></textarea>
                                                ...
                                                <div id="medsos">
                                                    <?php if ($cruddata->medsos != "") { ?>
                                                        <?php foreach (json_decode($cruddata->medsos) as $key => $value) { ?>
                                                            <div class="row mb-1">
                                                                <div class="col-md-4">
                                                                    <input readonly type="text" name="medsos[]" class="form-control" placeholder="IG/FB/TWITTER" value="<?= $key ?>">
                                                                </div>
                                                                <div class="col-md-8">
                                                                    <input readonly type="text" name="medsosakun[]" class="form-control" placeholder="@kppa" value="<?= $value ?>">
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                    <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <textarea readonly class="form-control" name="rincian_kegiatan" placeholder="Garis Besar Kegiatan"><?= set_value('rincian_kegiatan', $cruddata->rincian_kegiatan ?? ''); ?></textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea readonly class="form-control" name="permasalahan" placeholder="Permasalahan"><?= set_value('permasalahan', $cruddata->permasalahan ?? ''); ?></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea readonly class="form-control" name="kebutuhan" placeholder="Kebutuhan"><?= set_value('kebutuhan'), $cruddata->kebutuhan ?? ''; ?></textarea>
